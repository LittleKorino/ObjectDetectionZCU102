...
void XConv_engine_Set_input_dram(XConv_engine *InstancePtr, u64 Data) {
    ...
    XConv_engine_WriteReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_INPUT_DRAM_DATA, (u32)(Data));
    XConv_engine_WriteReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_INPUT_DRAM_DATA + 4, (u32)(Data >> 32));
}
...
u64 XConv_engine_Get_input_dram(XConv_engine *InstancePtr) {
    ...
    Data = XConv_engine_ReadReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_INPUT_DRAM_DATA);
    Data += (u64)XConv_engine_ReadReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_INPUT_DRAM_DATA + 4) << 32;
    return Data;
}
...
void XConv_engine_Set_output_dram(XConv_engine *InstancePtr, u64 Data) {
    ...
    XConv_engine_WriteReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_OUTPUT_DRAM_DATA, (u32)(Data));
    XConv_engine_WriteReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_OUTPUT_DRAM_DATA + 4, (u32)(Data >> 32));
}
...
u64 XConv_engine_Get_output_dram(XConv_engine *InstancePtr) {
    ...
    Data = XConv_engine_ReadReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_OUTPUT_DRAM_DATA);
    Data += (u64)XConv_engine_ReadReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_OUTPUT_DRAM_DATA + 4) << 32;
    return Data;
}
...
void XConv_engine_Set_weights_dram(XConv_engine *InstancePtr, u64 Data) {
    ...
    XConv_engine_WriteReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_WEIGHTS_DRAM_DATA, (u32)(Data));
    XConv_engine_WriteReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_WEIGHTS_DRAM_DATA + 4, (u32)(Data >> 32));
}
...
u64 XConv_engine_Get_weights_dram(XConv_engine *InstancePtr) {
    ...
    Data = XConv_engine_ReadReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_WEIGHTS_DRAM_DATA);
    Data += (u64)XConv_engine_ReadReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_WEIGHTS_DRAM_DATA + 4) << 32;
    return Data;
}
...
void XConv_engine_Set_bn_params_dram(XConv_engine *InstancePtr, u64 Data) {
    ...
    XConv_engine_WriteReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_BN_PARAMS_DRAM_DATA, (u32)(Data));
    XConv_engine_WriteReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_BN_PARAMS_DRAM_DATA + 4, (u32)(Data >> 32));
}
...
u64 XConv_engine_Get_bn_params_dram(XConv_engine *InstancePtr) {
    ...
    Data = XConv_engine_ReadReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_BN_PARAMS_DRAM_DATA);
    Data += (u64)XConv_engine_ReadReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_BN_PARAMS_DRAM_DATA + 4) << 32;
    return Data;
}
...
void XConv_engine_Set_pool_stride(XConv_engine *InstancePtr, u32 Data) {
    ...
    XConv_engine_WriteReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_POOL_STRIDE_DATA, Data);
}
...
u32 XConv_engine_Get_pool_stride(XConv_engine *InstancePtr) {
    ...
    Data = XConv_engine_ReadReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_POOL_STRIDE_DATA);
    return Data;
}
...
void XConv_engine_Set_use_leaky(XConv_engine *InstancePtr, u32 Data) {
    ...
    XConv_engine_WriteReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_USE_LEAKY_DATA, Data);
}
...
u32 XConv_engine_Get_use_leaky(XConv_engine *InstancePtr) {
    ...
    Data = XConv_engine_ReadReg(InstancePtr->Control_BaseAddress, XCONV_ENGINE_CONTROL_ADDR_USE_LEAKY_DATA);
    return Data;
}
